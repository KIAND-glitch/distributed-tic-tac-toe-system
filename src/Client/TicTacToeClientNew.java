...
public class TicTacToeClientNew extends UnicastRemoteObject implements ClientCallback {
    ...
    public TicTacToeClientNew(String playerName) throws Exception {
    ...
    public void resumeGame() throws RemoteException {
        SwingUtilities.invokeLater(() -> {
            ...
            try {
                ...
                if (myTurn) {
                    notifyTurn(); // This calls the notifyTurn callback method
                } else {
                    gui.updateGameInfo("Rank#" + opponentRank + " " +opponentName + "'s turn (" + opponentChar + ")");
                }
            } catch (RemoteException e) {
